      ...
      <div className="about-section flex flex-col items-center justify-center p-6 border border-gray-200 rounded-lg relative w-full max-w-4xl mx-auto">
        <div className='mb-5'>
          <p className='about-text'>
            ...
            We created this platform with a clear goal – making your mountain biking adventures as accessible and enjoyable as possible. We know the excitement of hitting the trails, and we believe that renting a quality mountain bike should be simple and straightforward.<br /><br />
