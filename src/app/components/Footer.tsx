      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="mb-6 md:mb-0">
          ...
          <div className="flex p-2">
            <a href="https://github.com/aksiooma/trailbuddy-app" target="_blank" rel="noopener noreferrer" className="p-1"><svg xmlns="http://www.w3.org/2000/svg" className="hover:bg-rose-700/50 rounded-full transition-colors duration-200" width="28" height="28" fill="currentColor" viewBox="0 0 16 16">
